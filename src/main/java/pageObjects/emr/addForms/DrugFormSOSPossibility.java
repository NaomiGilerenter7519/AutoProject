...
public class DrugFormSOSPossibility {
    ...
    @FindBy(how= How.XPATH, using="//button[@id='sosMaxTimesPerDay']/following-sibling::ul")
    ...
    @FindBy(how= How.XPATH, using="//button[@id='sosMinTimesPerDay']/following-sibling::ul")
